# ─────────────────────────────────────────────────────────────────────────────
# AURA OPS — Instalar GitHub Actions Self-Hosted Runner en Windows
# Uso: .\scripts\setup-github-runner.ps1 -Token TU_TOKEN_DE_GITHUB
#
# El token lo obtienes en:
#   github.com/TU_USUARIO/aura-ops → Settings → Actions → Runners → New self-hosted runner
# ─────────────────────────────────────────────────────────────────────────────
...
param(
    ...
    [string]$RepoUrl = "https://github.com/TU_USUARIO/aura-ops",
...
& "$RunnerDir\config.cmd" --url $RepoUrl --token $Token --name "aura-ops-local" --labels "self-hosted,windows,x64" --work "_work" --unattended
...
Write-Host "   Nombre: aura-ops-local"
Write-Host "   Servicio: actions.runner.TU_USUARIO-aura-ops.aura-ops-local"
Write-Host ""
