-- ─────────────────────────────────────────────────────────────────
-- AURA OPS — ClickHouse schema inicial
-- Se ejecuta automáticamente al primer arranque del contenedor
-- ─────────────────────────────────────────────────────────────────

CREATE DATABASE IF NOT EXISTS aura_analytics;

-- Resultados de auditorías OSINT
CREATE TABLE IF NOT EXISTS aura_analytics.audit_results (
...
CREATE TABLE IF NOT EXISTS aura_analytics.scan_events (
    id          UUID DEFAULT generateUUIDv4(),
...
CREATE TABLE IF NOT EXISTS aura_analytics.api_calls (
...
CREATE VIEW IF NOT EXISTS aura_analytics.daily_summary AS
SELECT
...
FROM aura_analytics.audit_results
