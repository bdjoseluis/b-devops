...
// ─── Workflows reales en n8n (los 5 publicados) ───────────────────────────────
const PRESET_WORKFLOWS = [
  {
    id: 'lead-intake',
    name: 'Lead Intake → Notion CRM',
    desc: 'Recibe leads externos (carsimport, psicología, bolsos) y los guarda en Notion',
    icon: Globe,
    color: 'text-blue-400',
    bg: 'bg-blue-900/20',
    ...
    params: [
      { key: 'nombre', label: 'Nombre', placeholder: 'Cliente de prueba' },
      { key: 'email', label: 'Email', placeholder: 'cliente@email.com' },
      { key: 'fuente', label: 'Fuente', placeholder: 'carsimport' },
    ],
  },
  {
    id: 'grafana-alert',
    name: 'Grafana Alerts → Notion',
    desc: 'Recibe alertas de Grafana (CPU, RAM, contenedores caídos) y las registra',
    icon: AlertTriangle,
    color: 'text-red-400',
    bg: 'bg-red-900/20',
    border: 'border-red-700/30',
    webhook: '/webhook/grafana-alert',
    params: [{ key: 'title', label: 'Título alerta (test)', placeholder: '🚨 ALERTA: HostCpuHigh' }],
  },
  {
    id: 'user-register',
    name: 'User Register → Notion',
    desc: 'Cuando un nuevo usuario se registra en la plataforma, se notifica en Notion',
    icon: Activity,
    color: 'text-green-400',
    bg: 'bg-green-900/20',
    border: 'border-green-700/30',
    webhook: '/webhook/user-register',
    params: [{ key: 'username', label: 'Username (test)', placeholder: 'usuario_test' }],
  },
  {
    id: 'client-created',
    name: 'Client CRM → Notion Sync',
    desc: 'Sincroniza clientes creados/actualizados en la BD con la base Notion',
    icon: Mail,
